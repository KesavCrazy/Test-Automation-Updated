...
public class MusicalOrderDelete extends BaseTest{
	...
	new QuantityAddToCartBuyNow(driver,test).cart();
	
	new QuantityAddToCartBuyNow(driver,test).dropdownLabel();
	
	new QuantityAddToCartBuyNow(driver,test).dropdownLabel3();
	
	new QuantityAddToCartBuyNow(driver,test).saveForLater();
